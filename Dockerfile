...
RUN apk add --no-cache python3 make g++ cairo-dev jpeg-dev pango-dev giflib-dev pkg-config
...
RUN apk add --no-cache python3 py3-pip bash cairo jpeg pango giflib pkgconf
